...
#ifndef VL53L0X_TOF_H
#define VL53L0X_TOF_H
 ...
 *
 */
typedef volatile VL53L0X_Dev_t *VL53L0X_DEV;
...
// ist nicht mein code, sauber ist das alles nicht, aber die Warnings stoeren
// die teilnehmer....
 ...
 * @return  "Other error code"    See ::VL53L0X_Error
 */
VL53L0X_Error VL53L0X_RdWord(volatile VL53L0X_DEV Dev, uint8_t index,
                             uint16_t *data);
